...
ds_collections = {
    'slake': {
        'root': '/home/liyh/dataset/Slake1.0/imgs/',
        'annotation':"/home/liyh/InternVL-main/internvl_chat/data/single_image/slake_test.json",
        'max_new_tokens': 90,
        'min_new_tokens': 1,
    }
}
...
def evaluate_chat_model():
    ...
    for ds_name in args.datasets:
        ...
        if torch.distributed.get_rank() == 0:
            ...
            gts_file = f'{"gts"}_{time_prefix}.json'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--datasets', type=str, default='slake')
